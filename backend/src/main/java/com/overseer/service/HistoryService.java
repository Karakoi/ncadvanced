...
public interface HistoryService {
    ...
    /**
     * Method returns a {@link List} of {@link History} entities which have an information about changes
     ...
     * @return {@link List} of {@link History} entities.
     */
    List<History> findHistoryList(Long entityId);

    /**
     * Method returns a {@link List} of {@link HistoryMessageDTO} entities which have an information about changes
     * of transferred entity.
     *
     * @param entityId id of entity for which we need to get all history of changes, must not be {@literal null}.
     ...
     *
     * @param histories {@link List} of {@link History} objects that will be converted to {@link List}
     *                              of {@link HistoryMessageDTO} objects.
     * @param maxNumberOfCharsInText max number of chars in long string values, if we need to trim its.
