...
public class RequestDaoImpl implements RequestDao{
    ...
    private static final String SELECT_REQUEST_BY_PROGRESS_STATUS = "SELECT * FROM request r WHERE r.progress_status =: progressStatus";
    private static final String SELECT_REQUEST_BY_JOINED_REQUEST_ID = "SELECT * FROM request r WHERE r.joined_request_id =: joinedRequestId";
    private static final String SELECT_REQUEST_BY_REPORTER_ID = "SELECT * FROM request r WHERE r.reporter_id =: reporterId";
    private static final String SELECT_REQUEST_BY_ASSIGNEE_ID = "SELECT * FROM request r WHERE r.assignee_id =: assigneeId";
    private static final String SELECT_REQUEST_BY_PERIOD = "SELECT * FROM request r WHERE r.date_of_creation BETWEEN :begin AND :end";
    private static final String SELECT_REQUEST_BY_DATE = "SELECT * FROM request r WHERE r.date_of_creation =: date";
    private static final String SELECT_REQUEST_BY_PRIORITY_STATUS = "SELECT * FROM request r WHERE r.priority_status =: priorityStatus";
    ...
    public List<Request> getRequestsByStatus(ProgressStatus progressStatus) {
        ...
        return namedParameterJdbcTemplate.query(SELECT_REQUEST_BY_PROGRESS_STATUS, new MapSqlParameterSource("progressStatus", progressStatus.name()), new RequestMapper());
    }
    ...
    public List<Request> getRequestsByJoined(Long joinedRequestId) {
        ...
        return namedParameterJdbcTemplate.query(SELECT_REQUEST_BY_JOINED_REQUEST_ID, new MapSqlParameterSource("joinedRequestId", joinedRequestId), new RequestMapper());
    }
    ...
    public List<Request> getRequestsByAssignee(Long assigneeId) {
        ...
        return namedParameterJdbcTemplate.query(SELECT_REQUEST_BY_ASSIGNEE_ID, new MapSqlParameterSource("assigneeId", assigneeId), new RequestMapper());
    }
    ...
    public List<Request> getRequestsByReporter(Long reporterId) {
        ...
        return namedParameterJdbcTemplate.query(SELECT_REQUEST_BY_REPORTER_ID, new MapSqlParameterSource("reporterId", reporterId), new RequestMapper());
    }
    ...
    public List<Request> getRequestsByPeriod(LocalDate begin, LocalDate end) {
        ...
        return namedParameterJdbcTemplate.query(SELECT_REQUEST_BY_PERIOD, mapSqlParameterSource, new RequestMapper());
    }
    ...
    public List<Request> getRequestByDate(LocalDate date) {
        ...
        return namedParameterJdbcTemplate.query(SELECT_REQUEST_BY_DATE, mapSqlParameterSource, new RequestMapper());
    }
    ...
    public List<Request> getRequestsByPriority(PriorityStatus priorityStatus) {
        ...
        return namedParameterJdbcTemplate.query(SELECT_REQUEST_BY_PRIORITY_STATUS, new MapSqlParameterSource("priorityStatus", priorityStatus.name()), new RequestMapper());
    }
    ...
    public Request save(Request request) {
        ...
        if (findOne(request.getId()) != null) {
            ...
            namedParameterJdbcTemplate.update(UPDATE_REQUEST_BY_ID, mapSqlParameterSource);
        } else {
            KeyHolder keyHolder = new GeneratedKeyHolder();
            namedParameterJdbcTemplate.update(INSERT_REQUEST, mapSqlParameterSource, keyHolder);
    ...
    public Request findOne(Long id) {
        Assert.notNull(id);
        return namedParameterJdbcTemplate.queryForObject(SELECT_REQUEST_BY_ID, new MapSqlParameterSource("id", id), new RequestMapper());
    }
    ...
    public void delete(Long id) {
        Assert.notNull(id);
        namedParameterJdbcTemplate.update(DELETE_REQUEST_BY_ID, new MapSqlParameterSource("id", id));
    }
    ...
    public List<Request> findAll() {
        return namedParameterJdbcTemplate.query(SELECT_ALL_REQUESTS, new RequestMapper());
    }
